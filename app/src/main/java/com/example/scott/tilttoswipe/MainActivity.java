...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private double THRESHOLD = 0.3; // sensor value that constitutes a valid tilt
    ...
    // minimum gyroscope value for a tilt to be recognized
    private float yTilt, prevYTilt;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Log.i(TAG, "onSensorChanged: " + yTilt);

        // phone is being tilted
        if (yTilt > THRESHOLD) {
            mViewPager.setCurrentItem(mViewPager.getCurrentItem()+1);
            isSwitching = true;
            handler.postDelayed(r, delayMillis);
        } else if (yTilt < -THRESHOLD) {
            mViewPager.setCurrentItem(mViewPager.getCurrentItem()-1);
            isSwitching = true;
            handler.postDelayed(r, delayMillis);
        }
